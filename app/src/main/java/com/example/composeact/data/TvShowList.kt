...
import com.example.composeact.R
...
object TvShowList {
    ...
    val tvShows = listOf(
        ...
        TvShow(
            ...
            overview = "This Idiot was Bored and unhappy as the Lord of Hell, Lucifer Duduhead Morningstar abandoned his throne and retired to Los Angeles, where he has teamed up with LAPD detective Chloe Decker to take down criminals. But the longer he's away from the underworld, the greater the threat that the worst of humanity could escape."
        ),
        TvShow(
            id = 2,
            name = "Ragnarok",
